...
export const TEST_WORD_SEARCH_ACTIVITY_ID =
  process.env.E2E_WORD_SEARCH_ACTIVITY_ID ?? '';
export const TEST_DRAG_DROP_ACTIVITY_ID =
  process.env.E2E_DRAG_DROP_ACTIVITY_ID ?? '';
